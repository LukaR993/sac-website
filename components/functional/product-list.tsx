...
export default function ProductList(params: { locale: Locale; categoryId?: string; title: string }) {
  ...
  const { data, refetch } = useQuery({
    queryKey: ["products", params.locale, { category: searchParams.get("category"), subcategory: searchParams.get("subcategory"), key: key }],
    queryFn: () => getArticles({ category: searchParams.get("category") || undefined, subcategory: searchParams.get("subcategory") || undefined }, key),
  });
