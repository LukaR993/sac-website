...
export default function ProductList(params: { locale: Locale; categoryId?: string; title: string }) {
  ...
  const { data, refetch } = useQuery({
    queryKey: ["products", params.locale, { category: searchParams.get("category"), subcategory: searchParams.get("subcategory"), title: searchParams.get("title"), key: key }],
    queryFn: () => getArticles({ category: searchParams.get("category") || undefined, subcategory: searchParams.get("subcategory") || undefined, title: searchParams.get("title") || undefined }, key),
  });
